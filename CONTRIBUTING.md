...
1. [Fork the repository](https://github.com/tecnickcom/tc-lib-file/fork) and create a branch from `main`:
   ```bash
...
1. **Open a Feature Request** on [GitHub Issues](https://github.com/tecnickcom/tc-lib-file/issues/new) describing the use case and proposed API.
